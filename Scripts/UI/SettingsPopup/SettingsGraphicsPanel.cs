...
namespace UI
{
    class SettingsGraphicsPanel: SettingsCategoryPanel
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            ElementFactory.CreateToggleSetting(DoublePanelRight, style, settings.RecordingClipAfterKill, UIManager.GetLocale("", "", "RecordingClipAfterKill"), tooltip: UIManager.GetLocale("","","Click to enable replay function"));
        }
    }
}
