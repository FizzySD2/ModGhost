...
public class logger : Photon.MonoBehaviour
{
    ...
    public void OnGUI()
    {
        if (RPCConsole)
        {
            ...
            GuiRect = new Rect(Screen.width - 300f, (float)(Screen.height - 500), 300f, 470f);
            ...
            GUILayout.Label(text, currentStyle, new GUILayoutOption[0]);
            GUILayout.EndArea();
            GUILayout.BeginArea(GuiRect);
    ...
    {
        bool alignBottom = this.AlignBottom;
    }
    ...
    public void Start()
    {
        ...
        logger.addLINE("<color=#ff00b4>W</color><color=#ec00c1>e</color><color=#d800cd>l</color><color=#c500da>c</color><color=#b200e6>o</color><color=#9e00f3>m</color><color=#8b00ff>e</color>, " + FengGameManagerMKII.nameField.hexColor()); ;
    }
    public void Update()
    {
